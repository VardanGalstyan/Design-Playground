...
const Header = () => {
  ...
  return (
    <div className="fixed top-10 h-10 px-10 left-0 right-0 flex-row-reverse mix-blend-difference flex justify-between items-center">
      <div
        onClick={() => toOpen(!open)}
        className="flex flex-col cursor-pointer items-end w-24 group gap-1"
      >
      ...
      <nav className="uppercase ease-linear animation-all p-4 text-4xl ">
